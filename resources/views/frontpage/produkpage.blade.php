        ...
        <div class="mt-10">
          ...
          <div class="mt-4">
            <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
              <li class="text-gray-400"><span class="text-gray-600">Dipotong dengan tangan dan dijahit secara lokal</span></li>

              <li class="text-gray-400"><span class="text-gray-600">Dicelup dengan warna milik kami Pra-dicuci & pra-menyusut</span></li>

              <li class="text-gray-400"><span class="text-gray-600">Pra-dicuci &amp; pra-menyusut</span></li>

              <li class="text-gray-400"><span class="text-gray-600">Katun 100% sangat lembut</span></li>
            </ul>
          </div>
        </div>
